...
public class ForgotLoginMethod extends Base{
    ...
    public static void forgotLogin(){
        ...
        driver.findElement(By.xpath("/html/body/div[1]/div[3]/div[2]/form/table/tbody/tr[7]/td[2]/input")).sendKeys("123456789");
